            ...
            <div class="modal fade" id="addBanner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form action="{{ url('place/new/action') }}" method="POST">
                    <div class="modal-body">                      
                      ...
                      <div class="form-group">
                        <label for="titleBn">Bangla Title</label>
                        <input type="text" class="form-control" id="titleBn" name="titleBn" placeholder="Bangla Title" required>
                      </div>
            ...
            <table  class="table table-striped dt-responsive nowrap w-100">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <form action="{{ url('place/delete', $item->token) }}" method="POST" style="display:inline; margin:0px; padding:0px">
                          @csrf
                          <button type="submit" class="btn btn-danger" onclick="if (!confirm('Are you want to delete this Place?')) { return false }">Delete</button>
                        </form>
                      </div>
                    </td>                  
                  </tr>                  
                ...
                <div class="modal fade" id="view{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="view{{$item->id}}" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="view{{$item->id}}">Place Details</h5>                        
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>                      
                      <div class="modal-body">                        
                        ...
                        <div class="form-group">
                          <label for="titleBn">Bangla Title</label>
                          <input type="text" class="form-control" id="titleBn" name="titleBn" value="{{$item->title_bn}}"  placeholder="Bangla Title" readonly>
                        </div>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                ...
                <div class="modal fade" id="edit{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="edit{{$item->id}}" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="edit{{$item->id}}">Place Edit</h5>
                        
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div> 
                      <form action="{{ url('place/update', $item->token) }}" method="POST">                     
                        <div class="modal-body">
                          @csrf
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titleBn" name="titleBn" value="{{$item->title_bn}}" placeholder="Title Bangla" required>
                          </div>   
