...
//                    }
    ...
    {
        $this->successUrl = url('/api/app_user') . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = url('/api/app_user') . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = url('/api/app_user/') . $this->config['cancel_url'];
    }
