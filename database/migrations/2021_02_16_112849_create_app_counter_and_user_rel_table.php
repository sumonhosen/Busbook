...
class CreateAppCounterAndUserRelTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('app_counter_and_user_rel', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('app_counter_and_user_rel');
    }
}
